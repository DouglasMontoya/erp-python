...
# Monkey patch function we can use to shave a second off our tests by skipping
# the password hashing check
...
def test_wrong_password(client, test_db, test_user,
                        test_password, monkeypatch):
